...
const About: React.FC<AboutProps> = (props) => {
    return (
        ...
        <div className="site-page-content">
            ...
            <h3>I'm Jermaine Munene</h3>
            <br />
            <div className="text-block">
                <p>
                    I'm 4th year student at kenyatta university. I have extensive 
                ...
                <p>
                    ...
                    <a href="mailto:fustrumstudios@gmail.com">
                        fustrumstudios@gmail.com
                    </a>
                </p>
            </div>
            <ResumeDownload />
            <div className="text-block">
                ...
                <p>
                    ...
                    worked. Life was difficult growing up, and I often found money
                    was tight for my family. I wanted to find a way to make things
                    easier for us. My mother saw my unbridled passion for computers
                    and supported me, got me my first laptop. There started my journey
                    programming and software development.A way to potentially
                    create a better future for myself, my family and end users.
                </p>
                <br />
                ...
                <br />
                <p>
                    In 2019, I got accepted into Kenyatta university
                    to study Computer Science. It was my first choice
                ...
                <div style={{}}>
                    ...
                    >
                        ...
                        <br />
                        <p>
                            In college, I was an active member in the kenyatta
                            university chess club, model UN  and held multiple positions in
                            the chapters. I met a lot of amazing people through
                ...
                <p>
                    ...
                    <a
                        rel="noreferrer"
                        target="_blank"
                        href="https://twitter.com/fustrumstudios"
                    >
                        @fustrumstudios
                    </a>{' '}
